...
| 052 | `INV-CIVILIZATIONS-001` | [¿Cómo comparamos arqueológicamente las primeras civilizaciones sin esencia, checklist ni ranking?](14_civilizaciones/INVESTIGACION_052_COMPARACION_PRIMERAS_CIVILIZACIONES.md) — **AUDITADO** |
...
| CIV-003 | `INV-CIV-SWASIA-001` | [Asia sudoccidental: campamentos, aldeas y urbanismos del norte y del sur](14_civilizaciones/INVESTIGACION_CIV_003_ASIA_SUDOCCIDENTAL_CAMPAMENTOS_ALDEAS_URBANISMOS.md) | **AUDITADO** |

El marco crítico y el programa regional están en [`14_civilizaciones/MARCO_CRITICO_CIVILIZACION.md`](14_civilizaciones/MARCO_CRITICO_CIVILIZACION.md) y [`14_civilizaciones/PROGRAMA_CRONOLOGICO_GLOBAL.md`](14_civilizaciones/PROGRAMA_CRONOLOGICO_GLOBAL.md). CIV-002 aporta el fundamento cronológico y CIV-003 inaugura los expedientes regionales con Asia sudoccidental; promueve sólo cinco claims exactos de CIV-001, que permanece `TRAZADO`. La secuencia global `001–052` queda completa. El siguiente expediente regional recomendado es Nilo y África nororiental.
...
- `v0.2.2`: CIV-003 + historia regional + cronología por carriles + cadena sitio–región + portada original + módulo público «Cinco paisajes, ninguna cuna»; audita Asia sudoccidental sin origen único ni rankings.
...
MED-001 y MED-002 establecen el laboratorio transversal para evaluar intervenciones y pruebas. MED-003 abre la secuencia histórica mundial y sustituye cualquier fecha de nacimiento única por una cadena de seis capas. MED-004 audita los primeros archivos escritos densos de Mesopotamia y el valle del Nilo mediante la cadena objeto–texto–género–circulación–práctica–consecuencia. MED-005 aplica otra cadena de seis capas —testimonio–lectura–estrato–circulación–práctica–consecuencia— para impedir que copia, autor tradicional, descripción quirúrgica o antigüedad hereden fecha, continuidad o eficacia. MED-006 separa testigo, lectura, estrato, operación, institución y consecuencia para impedir que un canon herede práctica uniforme, cobertura o efecto. MED-007 separa testimonio, lectura, género, operación, institución y consecuencia para impedir que el corpus, los casos, el juramento, la cirugía, los `iamata` o la anatomía hereden autor único, práctica homogénea o resultado clínico. MED-008 separa vestigio, identificación, función, operación, acceso y consecuencia para impedir que edificio, título, instrumento, infraestructura, canon u hospital hereden cobertura o resultado. MED-009 separa archivo, procedencia, señal, inferencia, contraste y límite para impedir que el silencio, la analogía, la lesión, el manuscrito o el residuo hereden ausencia, continuidad, tratamiento o eficacia. MED-010 separa archivo, procedencia, señal, práctica, consecuencia y límite para impedir que abertura, remodelación, molécula, microresto o códice hereden indicación, beneficio o continuidad. MED-011 separa testigo, versión, operación, institución, alcance y consecuencia para impedir que traducción, caso, experimento, fundación, receta o norma hereden práctica o efecto. MED-012 separa testigo, versión, currículo, practicante, encuentro y alcance para impedir que manuscrito, traducción, autoridad, licencia, hospital o identidad hereden consulta o resultado. MED-013 separa huella, identificación, itinerario, mediación, recepción y alcance para impedir que barco, mercancía, manuscrito, regalo, imperio o imprenta hereden transferencia, práctica o eficacia. MED-014 separa testimonio, agente, magnitud, respuesta, cumplimiento y desigualdad para impedir que relato, genoma, fosa, decreto o descenso hereden diagnóstico, cifra, eficacia o justicia. MED-015 separa exposición, violencia, trabajo, nutrición, clasificación, respuesta y supervivencia para impedir que contacto, categoría, atención o continuidad hereden causa, identidad, benevolencia o ausencia de daño.
...
La siguiente investigación prevista es MED-016: anatomía, disección e imprenta, donde se separarán cuerpo disponible, procedimiento, imagen, texto, comparación, corrección y circulación sin hacer de Europa el único escenario ni de la disección una verdad automática.

Entregas públicas: MED-001 = `v0.3.0`; MED-002 = `v0.3.1`; MED-003 = `v0.3.2`; MED-004 = `v0.3.3`; MED-005 = `v0.3.4`; MED-006 = `v0.3.5`; MED-007 = `v0.3.6`; MED-008 = `v0.3.7`; MED-009 = `v0.3.8`; MED-010 = `v0.3.9`; MED-011 = `v0.3.10`; MED-012 = `v0.3.11`; MED-013 = `v0.3.12`; MED-014 = `v0.3.13`; MED-015 = `v0.3.14`.
