...
La siguiente investigación prevista es MED-009: África fuera del eje egipcio, donde se auditarán archivos de Nubia, Aksum, Sahel y otras regiones sin llenar silencios documentales con analogías.

Entregas públicas: MED-001 = `v0.3.0`; MED-002 = `v0.3.1`; MED-003 = `v0.3.2`; MED-004 = `v0.3.3`; MED-005 = `v0.3.4`; MED-006 = `v0.3.5`; MED-007 = `v0.3.6`; MED-008 = `v0.3.7`.
