...
La siguiente investigación prevista es MED-015: encuentros coloniales, donde se separarán exposición, violencia, trabajo, nutrición, clasificación, respuesta y supervivencia sin reducir la catástrofe a “contacto”.

Entregas públicas: MED-001 = `v0.3.0`; MED-002 = `v0.3.1`; MED-003 = `v0.3.2`; MED-004 = `v0.3.3`; MED-005 = `v0.3.4`; MED-006 = `v0.3.5`; MED-007 = `v0.3.6`; MED-008 = `v0.3.7`; MED-009 = `v0.3.8`; MED-010 = `v0.3.9`; MED-011 = `v0.3.10`; MED-012 = `v0.3.11`; MED-013 = `v0.3.12`; MED-014 = `v0.3.13`.
