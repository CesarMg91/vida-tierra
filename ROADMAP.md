...
La siguiente investigación prevista es MED-012: Europa medieval y tradiciones judías, donde se auditarán monasterios, universidades, hogares, cirugía, practicantes y redes textuales sin convertir Europa o judaísmo en bloques homogéneos ni narrar un relevo civilizatorio.

Entregas públicas: MED-001 = `v0.3.0`; MED-002 = `v0.3.1`; MED-003 = `v0.3.2`; MED-004 = `v0.3.3`; MED-005 = `v0.3.4`; MED-006 = `v0.3.5`; MED-007 = `v0.3.6`; MED-008 = `v0.3.7`; MED-009 = `v0.3.8`; MED-010 = `v0.3.9`; MED-011 = `v0.3.10`.
