...
La siguiente investigación prevista es MED-008: Roma, Bizancio y Mediterráneo tardío, donde se auditarán práctica militar, salud urbana, asistencia institucional y circulación de corpus sin convertir imperio, hospital o transmisión en cobertura universal.

Entregas públicas: MED-001 = `v0.3.0`; MED-002 = `v0.3.1`; MED-003 = `v0.3.2`; MED-004 = `v0.3.3`; MED-005 = `v0.3.4`; MED-006 = `v0.3.5`; MED-007 = `v0.3.6`.
