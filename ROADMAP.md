...
MED-001 y MED-002 establecen el laboratorio transversal para evaluar intervenciones y pruebas. MED-003–MED-017 desarrollan la secuencia histórica mundial con cadenas específicas de archivo y límite. MED-017 separa sistema heredado, preparación, intervención, medición, comparación, mecanismo y recepción para impedir que experimento, ligadura, cantidad, lente, publicación o fama hereden mecanismo completo, exactitud, consenso o resultado clínico.
...
La siguiente investigación prevista es MED-018: microscopía y anatomía patológica, donde se separarán tejido, lesión, preparación, autopsia, clasificación, correlación y enfermedad sin hacer de una imagen microscópica un diagnóstico o una causa automática.

Entregas públicas: MED-001 = `v0.3.0`; MED-002 = `v0.3.1`; MED-003 = `v0.3.2`; MED-004 = `v0.3.3`; MED-005 = `v0.3.4`; MED-006 = `v0.3.5`; MED-007 = `v0.3.6`; MED-008 = `v0.3.7`; MED-009 = `v0.3.8`; MED-010 = `v0.3.9`; MED-011 = `v0.3.10`; MED-012 = `v0.3.11`; MED-013 = `v0.3.12`; MED-014 = `v0.3.13`; MED-015 = `v0.3.14`; MED-016 = `v0.3.15`; MED-017 = `v0.3.16`.
