...
La siguiente investigación prevista es MED-007: Mediterráneo griego y helenístico, donde se distinguirán observación, pronóstico, escuelas, disección, corpus y práctica sin narrar una invención aislada de la medicina racional.

Entregas públicas: MED-001 = `v0.3.0`; MED-002 = `v0.3.1`; MED-003 = `v0.3.2`; MED-004 = `v0.3.3`; MED-005 = `v0.3.4`; MED-006 = `v0.3.5`.
