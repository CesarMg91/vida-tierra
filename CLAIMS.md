...
## MED-002 - Pruebas diagn�sticas, probabilidad y utilidad

| ID | Afirmaci�n delimitada | Confianza | Estado | Evidencias principales | Investigaci�n |
|---|---|---|---|---|---|
| `CLAIM-MED-DX-QUESTION-001` | Una prueba s�lo es evaluable bajo poblaci�n, uso previsto, condici�n objetivo, versi�n, umbral, referencia, comparador y consecuencias expl�citos. | A-SEM | AUDITADO | `EVID-MED-DX-QUESTION-THRESHOLD-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-INTENDED-USE-001` | Cribar, descartar, confirmar, clasificar, estadificar y monitorizar son usos distintos y no heredan autom�ticamente el mismo umbral o dise�o. | A-SEM | AUDITADO | `EVID-MED-DX-QUESTION-THRESHOLD-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-REFERENCE-001` | Una referencia imperfecta, incorporada o dependiente de la prueba �ndice puede clasificar err�neamente y sesgar la exactitud. | A m�todo | AUDITADO | `EVID-MED-DX-BIAS-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-SPECTRUM-001` | Casos inequ�vocos y controles sanos no representan necesariamente el espectro cl�nico y pueden inflar el rendimiento. | A m�todo | AUDITADO | `EVID-MED-DX-BIAS-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-VERIFICATION-001` | Verificar selectivamente seg�n el �ndice o con referencias distintas puede ocultar falsos negativos y alterar sensibilidad/especificidad. | A m�todo | AUDITADO | `EVID-MED-DX-BIAS-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-THRESHOLD-001` | Un umbral elegido despu�s de observar resultados optimiza la muestra; el uso cl�nico exige umbral y consecuencias preespecificados o validaci�n independiente. | A m�todo | AUDITADO | `EVID-MED-DX-QUESTION-THRESHOLD-001`, `EVID-MED-DX-UTILITY-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-METRICS-001` | Sensibilidad, especificidad, razones de verosimilitud, valores predictivos, AUC y calibraci�n describen productos distintos; ninguna m�trica aislada resume utilidad. | A-SEM | AUDITADO | `EVID-MED-DX-METRICS-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-PREVALENCE-001` | Los valores predictivos dependen de la frecuencia de la condici�n y sensibilidad/especificidad tambi�n pueden variar con espectro y contexto. | A m�todo/B transporte | AUDITADO | `EVID-MED-DX-METRICS-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-INDETERMINATE-001` | Excluir fallos t�cnicos o resultados indeterminados puede sobrestimar rendimiento y debe mostrarse con denominador y manejo. | A m�todo | AUDITADO | `EVID-MED-DX-BIAS-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-COMPARATIVE-001` | Comparar pruebas en poblaciones o referencias distintas no identifica su diferencia; las comparaciones leg�timas requieren dise�os emparejados o rutas comparables. | A m�todo | AUDITADO | `EVID-MED-DX-SYNTHESIS-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-UTILITY-001` | Exactitud diagn�stica no demuestra beneficio: utilidad exige conectar informaci�n con acciones, beneficios, da�os, carga y alternativas. | A-SEM/B | AUDITADO | `EVID-MED-DX-UTILITY-001`, `EVID-MED-DX-UKCTOCS-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-PREDICTION-001` | Un modelo predictivo requiere calibraci�n y validaci�n externa adem�s de discriminaci�n; desarrollo y evaluaci�n diagn�stica no son el mismo producto. | A m�todo | AUDITADO | `EVID-MED-DX-AI-MODELS-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-AI-001` | Para IA, desempe�o retrospectivo no demuestra estabilidad, equidad, integraci�n o utilidad prospectiva; datos, versi�n, uso y deriva deben auditarse. | A m�todo/B implementaci�n | AUDITADO | `EVID-MED-DX-AI-MODELS-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-RIFT-001` | En RIFT, las reglas de apendicitis tuvieron rendimiento dependiente de sexo y umbral; una puntuaci�n no sustituy� la ruta ni autoriz� extrapolaci�n. | A estudio/B alcance | AUDITADO | `EVID-MED-DX-RIFT-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-ADJUST-PE-001` | ADJUST-PE evalu� una estrategia secuencial con probabilidad pretest y D-d�mero ajustado por edad, no un umbral aislado aplicable a toda persona. | A estudio/B alcance | AUDITADO | `EVID-MED-DX-ADJUST-PE-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-PROPER-001` | PROPER mostr� que una ruta PERC redujo CTPA en pacientes de muy bajo riesgo seleccionados, con seguimiento de eventos; no valida PERC fuera de esa entrada. | A ensayo/B alcance | AUDITADO | `EVID-MED-DX-PROPER-001` | `INV-MED-DIAGNOSTICS-001` |
| `CLAIM-MED-DX-UKCTOCS-001` | En UKCTOCS, desplazar la distribuci�n de estadio no produjo reducci�n significativa de mortalidad por c�ncer ov�rico/tub�rico; detecci�n m�s temprana no garantiz� beneficio. | A ensayo/B generalizaci�n met�dica | AUDITADO | `EVID-MED-DX-UKCTOCS-001` | `INV-MED-DIAGNOSTICS-001` |
