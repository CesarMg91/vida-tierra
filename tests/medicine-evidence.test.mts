...
const data = JSON.parse(fs.readFileSync(path.join(ROOT, "content", "medicine-evidence.json"), "utf8"));
const kinds = ["question", "comparison", "outcomes", "estimate", "applicability", "decision"];

test("MED-001 conserva cuatro casos y seis capas en orden", () => {
...
test("cada capa clínica distingue observado, inferencia y límite", () => {
...
test("el módulo médico enlaza registros canónicos y expediente existente", () => {
