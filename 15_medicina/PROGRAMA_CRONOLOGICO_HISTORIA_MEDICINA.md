...
MED-003–MED-016 están auditados. MED-016 separa cuerpo disponible, procedimiento, imagen, texto, comparación, corrección y circulación en siete expedientes sin convertir Europa en escenario único, disección en verdad o imprenta en adopción. El siguiente expediente cronológico es MED-017 — circulación y fisiología: sistemas heredados, vivisección, ligaduras, medición y experimento sin un héroe único. El cambio de región o escala política no implica relevo lineal: las cronologías se solapan y las conexiones sólo se atribuyen cuando una ruta, texto, objeto, institución o agente las documenta.
