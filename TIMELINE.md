...
Las investigaciones extensas auditadas llegan de `INV-EARTH-AGE-001` a `INV-HADEAN-WATER-001`, con las piezas cósmicas, estelares, solares y planetarias intermedias. El siguiente trabajo cronológico es `INV-HADEAN-ATMOSPHERE-001`; deberá separar gases de desgasificación, estado redox y presión/composición atmosférica realmente restringida.
