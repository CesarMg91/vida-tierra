...
La versión `0.3.6` continúa la historia cronológica mundial de la medicina con MED-007: corpus hipocrático plural, casos y pronóstico, tratados quirúrgicos, santuarios, médicos públicos y anatomía helenística, separados por testimonio, género, operación y consecuencia. Incluye el módulo público «Observación escrita no es resultado clínico» y conserva MED-001–006 y CIV-001–003 íntegros; la secuencia global continúa cerrada en `001–052`.
