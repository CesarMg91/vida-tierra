...
La versión `0.3.1` añade MED-002: uso previsto, sesgos, exactitud, probabilidad y utilidad diagnóstica, junto con el módulo público «Una prueba no es una decisión». MED-001 y CIV-001–003 se conservan íntegros; la secuencia global continúa cerrada en `001–052`.
