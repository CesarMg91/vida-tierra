...
La versión `0.3.11` continúa la historia cronológica mundial de la medicina con MED-012: monasterios, hogares, traducciones, universidades, cirugía, hospitales y practicantes judíos en la Europa medieval, separados por testigo, versión, currículo, practicante, encuentro y alcance. Incluye el módulo público «Un currículo no hereda una consulta» y conserva MED-001–011 y CIV-001–003 íntegros; la secuencia global continúa cerrada en `001–052`.
