    ...
    <div className="page-shell methods-page">
      ...
      <section className="launch-transparency" aria-labelledby="launch-transparency-title">
        ...
        <div className="launch-transparency-links">
          ...
          <a href="https://github.com/CesarMg91/vida-tierra/blob/main/CITATION.cff" target="_blank" rel="noreferrer"><Quote aria-hidden="true" /><span><strong>Citar el proyecto</strong>Metadatos reutilizables de la versión 0.2.0</span><ArrowRight aria-hidden="true" /></a>
        </div>
      </section>
    </div>
  );
